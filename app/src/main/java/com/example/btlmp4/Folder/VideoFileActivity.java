...
public class VideoFileActivity extends AppCompatActivity implements SearchView.OnQueryTextListener {
    ...
    private ArrayList<MediaFile> fetchMedia(String folderName) {
        ...
        if (sort_value.equals("XếpTheoTen")) {
            //sắp xếp kết quả truy vấn MediaStore theo tên
        ...
        //truy vấn tất cả video trong folderName
        String selection = MediaStore.Video.Media.DATA + " like?";
        String[] selectionArg = new String[]{"%"+ folderName + "%"};
        //truy vấn vào cơ sở dữ liệu thông qua ContentResolver.
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if(id == R.id.sort_by){
            ...
            String[] items = {"Tên (Từ A đến Z)", "Kích thước (Từ lớn đến bé)", "Ngày (Từ mới đến cũ)",
    ...
    //Tìm kiếm ghi có sự thay đổi text trong thanh tìm kiếm
    @Override
